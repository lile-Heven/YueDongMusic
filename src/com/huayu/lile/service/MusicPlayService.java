...
//		contentView.setImageViewResource(R.id.notification_music_space1,
//				R.drawable.player_pre);
//		contentView.setImageViewResource(R.id.notification_music_space2,
//				R.drawable.player_pre);
		
		if (isPlay_or_not == 0) {
			contentView.setImageViewResource(
					R.id.notification_music_play_or_pause,
					R.drawable.musicplay_play);
		} else {
			contentView.setImageViewResource(
					R.id.notification_music_play_or_pause,
					R.drawable.musicplay_pause);
		}
