...
public class MusicShowAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tv_item_music_order=(TextView) convertView.findViewById(R.id.tv_item_music_order);
		...
		//--
		holder.tv_item_music_order.setText(position+1+".");
